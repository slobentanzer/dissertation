...
\DeclareAcronym{cht1}{
short = CHT1,
long = high affinity choline transporter 1,
extra = responsible for high affinity choline uptake; see HACU,
class = gene
}
\DeclareAcronym{cids}{
short = CIDS,
...
\DeclareAcronym{hacu}{
short = HACU,
long = high affinity choline uptake,
extra = conveyed by CHT1 protein,
class = abb
}
...
\DeclareAcronym{slc5}{
short = SLC5A7,
long = high affinity choline transporter,
extra = official gene symbol; see CHT1,
class = gene
}
